...
## Tasks
* Day 1 In Class:  `doubly_linked_list` - done
* Day 1 Homework:  `queue_and_stack` - done 
* Day 2 In Class:  No Starter.  Interview problems described below. - done
* Day 2 Homework:  `lru_cache` done
* Day 3 In Class:  No Starter. Research and planning exercise below. done
